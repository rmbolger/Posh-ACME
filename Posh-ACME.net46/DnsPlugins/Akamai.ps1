function Add-DnsTxtAkamai {
    ...
    .EXAMPLE
        ...
        PS C:\>Add-DnsTxtAkamai '_acme-challenge.example.com' 'txt-value' @params
...
function Remove-DnsTxtAkamai {
    ...
    .EXAMPLE
        $secret = Read-Host -Prompt "Client Secret" -AsSecureString
        PS C:\>$params = @{AKHost='apihost.akamaiapis.net';AKAccessToken='token-value';AKClientToken='token-value';AKClientSecret=$secret}
        PS C:\>Remove-DnsTxtAkamai '_acme-challenge.example.com' 'txt-value' @params
